...
<header class="bg-asc-green text-white shadow-md sticky top-0 z-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
    ...
    <div class="flex items-center space-x-3 min-w-0">
      ...
      <!-- Logo -->
      <div class="w-10 h-10 flex-shrink-0 rounded-full bg-white flex items-center justify-center border-2 border-white shadow overflow-hidden">
        <img 
      ...
      <!-- College Name -->
      <div class="min-w-0">
        <h1 class="font-bold text-base sm:text-lg leading-tight tracking-wide uppercase truncate">
          Agogo State College
        </h1>
        <p class="text-xs text-amber-200 font-medium tracking-wider">
          Student Portal
        </p>
      </div>
    ...
    <div class="flex items-center space-x-4 flex-shrink-0">
      ...
      <button class="w-9 h-9 flex-shrink-0 rounded-full bg-asc-green-dark flex items-center justify-center border border-amber-400 text-amber-300 hover:text-white transition">
